...
public class UpdateUserMoneyAction implements Action {
    public final static Logger log = Logger.getLogger(UpdateUserMoneyAction.class);
    private UserService userService = ServiceFactory.getInstance().createUserService();

    public UpdateUserMoneyAction() {
    }

    public UpdateUserMoneyAction(final ServiceFactory serviceFactory) {
