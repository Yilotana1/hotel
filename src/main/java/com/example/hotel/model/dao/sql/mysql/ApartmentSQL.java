...
public interface ApartmentSQL {
    ...
    String SELECT_APARTMENTS_SORTED_BY_NUMBER = "SELECT * FROM Apartment ORDER BY number LIMIT ?,?";
    ...
    String SELECT_APARTMENTS_SORTED_BY_CLASS = "SELECT number, floor, class_id, status_id, demand, price, number_of_people" +
            "  FROM Apartment JOIN Class ON class_id = class.id ORDER BY Class.priority LIMIT ?,?";
    ...
    String SELECT_APARTMENTS_SORTED_BY_NUMBER_OF_PEOPLE = "SELECT * FROM Apartment ORDER BY number_of_people LIMIT ?,?";
    String SELECT_APARTMENTS_SORTED_BY_NUMBER_OF_PEOPLE_DESC = "SELECT * FROM Apartment ORDER BY number_of_people DESC LIMIT ?,?";
    String SELECT_APARTMENTS_SORTED_BY_PRICE = "SELECT * FROM Apartment ORDER BY price LIMIT ?,?";
    String SELECT_APARTMENTS_SORTED_BY_PRICE_DESC = "SELECT * FROM Apartment ORDER BY price DESC LIMIT ?,?";
    String SELECT_APARTMENTS_BY_CLASS = "SELECT * FROM Apartment WHERE class_id = ? LIMIT ?, ?";
